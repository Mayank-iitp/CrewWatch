...
from .utils import latency_per_token
import tiktoken
...
class CrewWatch:
    ...
    def end(self):
        ...
        self.latency_per_token= latency_per_token(self.total_tokens, self.total_time)
        ...
        self.logger.log(f"Latency per Token:{self.latency_per_token:.6f}")
...
class CrewWatchExtra(CrewWatch):
    def __init__(self, model: str, enable_monitoring: bool = True, encoding_name: str = "cl100k_base"):
